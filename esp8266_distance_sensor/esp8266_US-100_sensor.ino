...
const char* topic = "ESP8266/sensor/US-100/distance";


unsigned int echoPin = 12;	 // 将Arduino 的Pin2 连接至US-100 的Echo/RX
unsigned int trigPin = 14;	 // 将Arduino 的Pin3 连接至US-100 的Trig/TX
